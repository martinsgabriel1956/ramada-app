		...
		<>
			...
			<div className="relative sm:flex sm:justify-center sm:items-center flex-col min-h-screen bg-dots-darker bg-center bg-gray-900 dark:bg-dots-lighter dark:bg-gray-900 px-72">
				<div className="relative w-full flex items-center justify-center">
					<h1 className='text-sky-100 font-bold text-6xl mb-12'>Ramada Produtos</h1>
					<Link href="/create-product" className='text-white font-normal text-xl absolute right-0 top-4 border px-4 py-2 rounded-lg border-sky-500 hover:bg-sky-500 transition ease-in delay-50'>Criar produto</Link>
				</div>
				...
				{products.length <= 0 && (
					<div className='text-center'>
						<h1 className='text-white text-2xl'>Não existe produtos cadastrados</h1>
						<span className='text-xl text-white mt-2 inline-flex'>Basta clicar no botão <strong className='ml-1 text-sky-500'>criar produto</strong>.</span>
					</div>
				)}
			</div>
		</>
